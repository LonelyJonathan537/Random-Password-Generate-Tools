...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        ' ToolStripMenuItem1
        ' 
        ToolStripMenuItem1.DropDownItems.AddRange(New ToolStripItem() {ExitToolStripMenuItem, PasswordHistoryToolStripMenuItem, PasswordTestToolStripMenuItem})
        ...
        PasswordHistoryToolStripMenuItem.Size = New Size(224, 26)
        ...
        PasswordTestToolStripMenuItem.Size = New Size(224, 26)
        PasswordTestToolStripMenuItem.Text = "Password Test"
        ' 
        ' ToolStripMenuItem2
        ' 
